...
const TRACKS: Track[] = [
  ...
  },
  {
    ...
    title: "AI PROMPTING",
    desc: "Master prompt engineering through structured modules. Module 1 is free — start now. Pro unlocks all 4 modules with AI judge feedback.",
    features: ["Module 1 free", "AI judge scoring", "Pro unlocks modules 2–4"],
    color: "#f59e0b", free: true,
    badge: { text: "FREE START", color: "#f59e0b", bg: "rgba(245,158,11,0.08)" },
    btnText: "Start Learning →",
  },
  {
    ...
    title: "AGENTIC TRACK",
    desc: "4 seasons · 75 cards. Season 0 is free — build your mental model. Pro unlocks seasons 1–3 for the full agentic stack.",
    features: ["Season 0 free", "MCQ + open-ended cards", "Pro unlocks seasons 1–3"],
    color: "#06b6d4", free: true,
    badge: { text: "FREE START", color: "#06b6d4", bg: "rgba(6,182,212,0.08)" },
    btnText: "Start Learning →",
  },
];
